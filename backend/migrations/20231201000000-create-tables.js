...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.addIndex('note_categories', ['noteId']);
    await queryInterface.addIndex('note_categories', ['categoryId']);
  },

  async down(queryInterface, Sequelize) {
    await queryInterface.dropTable('note_categories');
